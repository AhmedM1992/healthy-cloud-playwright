...
1. **[In Github Actions](https://github.com/AhmedM1992/healthy-cloud-playwright/actions)**: navigate to Github Actions -> Click on `Playwright Tests` -> Click on "Run workflow" -> Choose `dev` env and `main` branch (default values) -> Click on "Run workflow"
